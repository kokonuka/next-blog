...
export const GetNextPostsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getNextPosts" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<GetNextPostsQuery, GetNextPostsQueryVariables>;
