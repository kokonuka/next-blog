...
export type CategoryWhereCategoryNameQueryQueryVariables = Exact<{
  name?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>> | InputMaybe<Scalars['String']['input']>>;
}>;


export type CategoryWhereCategoryNameQueryQuery = { __typename?: 'RootQuery', categories?: { __typename?: 'RootQueryToCategoryConnection', nodes: Array<{ __typename?: 'Category', id: string, name?: string | null, posts?: { __typename?: 'CategoryToPostConnection', nodes: Array<(
          { __typename?: 'Post' }
